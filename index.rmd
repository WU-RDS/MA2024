...
mytable_sub_1 = data.frame(
    Assignment = c("Assignment 1: R Basics", 
             ...
             "Assignment 4: Factor and cluster analysis"
             ),
    Assigned = c(
      "Oct. 9",
      "Oct. 16",
    ...
    Coaching = c("Oct. 11, 04:00PM-06:00PM (online)*", 
                 "Oct. 25, 04:00PM-06:00PM (online)*",
                 "Nov. 8, 04:00PM-06:00PM (online)*",
                 "Nov. 22, 04:00PM-06:00PM (online)*"
             ),
    Submission = c(
      "Oct. 15, 11:59PM",
      "Oct. 29, 11:59PM",
...
mytable_sub_1 %>% kable(escape = F,  col.names = gsub("[_]", " ", names(mytable_sub_1))) %>%
  kable_paper(c("hover"), full_width = F) %>%
  footnote(general = "Dates and times are indicated for group A. 
           Dates indicated with '*' are optional time slots for individual online video coaching sessions with Julia.
           If you need to schedule a meeting, please contact Julia at least one day in advance (julia.wetschnig@wu.ac.at).",
           general_title = "Note: ", 
           footnote_as_chunk = T, title_format = c("italic")
           ) 
...
mytable_sub_1 = data.frame(
    ...
    Coaching = c("Oct. 16, 09:00PM-11:00AM (online)*", 
                 "Oct. 23, 09:00AM-11:00AM (online)*",
                 "Nov. 9, 02:00PM-04:00PM (online)*",
                 "Nov. 23, 02:00PM-04:00PM (online)*"
             ),
    Submission = c(
      "Oct. 17, 11:59PM",
      "Oct. 31, 11:59PM",
...
mytable_sub = data.frame(
    ...
    Date = c(
      "Nov. 20, 01:00PM - 05:00PM",
      "Nov. 27, 12:30PM - 04:30PM",
      "Dec. 11, 02:00PM - 06:00PM",
      "Jan. 5, 11:59PM"
    ),
    Room = c(
      "TC.-1.61",
...
mytable_sub = data.frame(
    ...
    Date = c(
      "Nov. 22, 12:00PM - 04:00PM",
      "Nov. 29, 12:00PM - 04:00PM",
      "Dec. 13, 10:30AM - 02:30PM",
      "Jan. 5, 11:59PM"
    ),
    Room = c(
      "TC.-1.61",
