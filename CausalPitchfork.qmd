...
This chapter deals with a fundamental question of causal inference: **Which variables should be included in a causal model?** [see @cinelli2020crash] To answer this question two points need to be clear:
...
Y_mod <- -0.15 * X_mod + 0.002 * X_mod * Moderator + rnorm(10000, sd = 4)
